...
class BlendShapeEditor(qute.QWidget):
    ...
    def add_connection_flow(self):
        ...
        blendshape_name = qute.utilities.request.item(
            title="Blend Shape",
            label="Please select the shape to add",
            items=shape_names,
            parent=self,
            editable=False,
        )
        ...
        driver = qute.utilities.request.text(
        ...
        division = qute.utilities.request.text(
        ...
        clamp = qute.utilities.request.confirmation(
            title="Clamp Range",
            label=(
    ...
    def add_connection(self, driver, shape, division, clamp):
        ...
        self.table.setItem(
            0,
            0,
            qute.QTableWidgetItem(driver),
        )
        self.table.setItem(
            0,
            1,
            qute.QTableWidgetItem(shape),
        )
        self.table.setItem(
            0,
            2,
            qute.QTableWidgetItem(str(division)),
        )
        self.table.setItem(
            0,
            3,
            qute.QTableWidgetItem(str(clamp)),
        )
